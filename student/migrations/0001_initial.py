# Generated by Django 3.2.7 on 2023-04-22 16:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(auto_now=True)),
                ('version', models.PositiveIntegerField(default=1)),
                ('attendance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='student.attendancemodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendance', models.ManyToManyField(blank=True, through='student.StudentAttendanceModel', to='student.AttendanceModel')),
            ],
            options={
                'db_table': 'students',
            },
        ...
        migrations.AddField(
            ...
            name='parent',
            field=models.ManyToManyField(blank=True, through='student.StudentParentModel', to='student.ParentModel'),
        ),
        migrations.AddField(
            model_name='studentmodel',
            name='student_parents',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='student.studentparentmodel'),
        ),
        migrations.AddField(
            model_name='studentmodel',
        ...
        migrations.AddField(
            model_name='attendancemodel',
            name='year_grade_section',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='student.yeargradesectionmodel'),
        ),
